...
export const TEAM = [
...

  {
    ...
    bio: [
      ...
      "Hablemos de tu próximo proyecto: hola@ruidodemate.studio.",
    ],
    trayectoria: [
      { puesto: "Directora de Arte, Ruido de Mate.", periodo: "(2023 - HOY)" },
...

  {
    ...
    bio: [
      ...
      "¿Sumamos magia a tu pieza? Escribíme a hola@ruidodemate.studio.",
    ],
    trayectoria: [
      { puesto: "Compositing / VFX Artist, Ruido de Mate.", periodo: "(2023 - HOY)" },
