...
export const TEAM = [
...

  {
    ...
    bio: [
      "Diseñadora de sonido y artista de foley. Construyo la identidad sonora de películas, series y cortos: ambientes, efectos y foley grabado y editado a medida.",
      "Trabajo el sonido como una capa narrativa más, buscando que cada escena tenga cuerpo y se sienta real.",
      "Podés ver algunos de mis trabajos en mi IMDb y en YouTube.",
    ],
    trayectoria: [
      { puesto: "Diseñadora de Sonido / Foley, Ruido de Mate.", periodo: "(2023 - HOY)" },
      { puesto: "Foley & Sound Design, Freelance.", periodo: "(2021 - 2023)" },
      { puesto: "Asistente de Sonido, Postproductora.", periodo: "(2019 - 2021)" },
    ],
    estudios: {
      izquierda: [
        { texto: "Diseño de Sonido para Cine.", periodo: "(2019)" },
        { texto: "Foley & Sound Design.", periodo: "(2020)" },
      ],
      derecha: [
        { texto: "Grabación y Edición de Audio.", periodo: "(2021)" },
        { texto: "Pro Tools, Certificación.", periodo: "(2022)" },
        { texto: "Sonido para Cine, Taller.", periodo: "(2020)" },
      ],
    },
    herramientas: [
      "Pro Tools", "Reaper", "Izotope RX", "Ableton Live", "Premiere",
    ],
    idiomas: ["Español nativo", "Inglés intermedio"],
  },
